...
const s = {
  php: {
    version:
      process.env.BROWSER_PHP_VERSION != null
        ? process.env.BROWSER_PHP_VERSION
        : "8.4",
  },
  composer: {
  ...
  server: {
    ...
    debug:
      process.env.BROWSER_PHP_SERVER_DEBUG != null &&
      process.env.BROWSER_PHP_SERVER_DEBUG != "false",
  },
};
export {s as default};
